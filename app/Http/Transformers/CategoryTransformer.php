...
class CategoryTransformer extends Transformer
{
    ...
    public function transform($item)
    {
        ...
        if(isset($item->products) && count($item->products))
        {
            ...
            foreach($item->products as $product)
            {
                ...
                $productImages = $productChart = $productPdf = [];
    ...
    public function getCategories($items, $productCount = 1000)
    {
        ...
        foreach($items as $item)
        {
            ...
            if(isset($item->products) && count($item->products))
            {
                ...
                foreach($item->products as $product)
                {
                    ...
                    if(isset($productCount) && $productCount == $sr)
                    {
                        break;
                    }
                ...
                $response[$main]['products'] = $productData;
            }

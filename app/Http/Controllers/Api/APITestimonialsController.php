...
class APITestimonialsController extends BaseApiController
{
    ...
    public function create(Request $request)
    {
        ...
        if($model)
        {
            $responseData = $this->testimonialsTransformer->transform($model);
    ...
    public function show(Request $request)
    {
        ...
        if($itemId)
        {
            ...
            if($itemData)
            {
                $responseData = $this->testimonialsTransformer->transform($itemData);
    ...
    public function edit(Request $request)
    {
        ...
        if($itemId)
        {
            ...
            if($status)
            {
                ...
                return $this->successResponse($responseData, 'Testimonials is Edited Successfully');
            }
        }

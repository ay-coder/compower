...
class APINotificationsController extends BaseApiController
{
    ...
    public function index(Request $request)
    {
        ...
        $items      = $paginate ? $this->repository->model->where('user_id', $userInfo->id)->orderBy($orderBy, $order)->paginate($paginate)->items() : $this->repository->getAll($userInfo->id, $orderBy, $order);

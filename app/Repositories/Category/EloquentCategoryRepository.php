...
class EloquentCategoryRepository extends DbRepository
{
    ...
    {
        return $this->model->with('products')->orderBy($orderBy, $sort)->get();
    }
     ...
     * @return mixed
     */
    public function getFilteredCategories($title = '', $orderBy = 'id', $sort = 'asc')
    {
        return $this->model->where('title', 'LIKE', '%'. $title .'%')->with('products')->orderBy($orderBy, $sort)->get();
    }

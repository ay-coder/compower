<?php namespace App\Models\Orders\Traits\Attribute;
...
trait Attribute
{
    ...
    public function getEditButtonAttribute($routes, $prefix = 'admin', $isAdmin = false)
    {
        ...
        return '<a href="'.route($prefix .'.'. $routes->editRoute, $id).'" class="btn btn-xs btn-success"><i class="fa fa-eye" data-toggle="tooltip" data-placement="top" title="View"></i></a> ';
    }
    ...
    {
        $repository = new EloquentOrdersRepository;

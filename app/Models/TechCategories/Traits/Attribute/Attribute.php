<?php namespace App\Models\TechCategories\Traits\Attribute;
...
use App\Repositories\TechCategories\EloquentTechCategoriesRepository;
...
trait Attribute
{
    ...
    {
        $repository = new EloquentTechCategoriesRepository;

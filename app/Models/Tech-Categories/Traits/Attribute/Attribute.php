<?php namespace App\Models\Tech-Categories\Traits\Attribute;
...
use App\Repositories\Tech-Categories\EloquentTech-CategoriesRepository;
...
trait Attribute
{
    ...
    {
        $repository = new EloquentTech-CategoriesRepository;
